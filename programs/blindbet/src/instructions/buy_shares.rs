...
use crate::{
    ...
    COMP_DEF_OFFSET_BUY_SHARES, ID,
};

#[init_computation_definition_accounts("buy_shares", payer)]
#[derive(Accounts)]
pub struct BuySharesCompDef<'info> {
    #[account(mut)]
...
#[queue_computation_accounts("buy_shares", signer)]
#[derive(Accounts)]
...
#[callback_accounts("buy_shares", signer)]
#[derive(Accounts)]
